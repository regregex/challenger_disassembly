...
; ----------------------------------------------------------------------------
        ...
        jsr     L9632                           ; 8903 20 32 96  2.
        jmp     L852A                           ; 8906 4C 2A 85 L*.

; ----------------------------------------------------------------------------
        jsr     select_ram_page_003             ; 8909 20 16 BE  ..
...
osargs_get_command_line_tail:
        ...
        sta     $03,x                           ; 9B93 95 03    ..
L9B96           := * + 1
        lda     $FDE2                           ; 9B95 AD E2 FD ...
        sta     $00,x                           ; 9B98 95 00    ..
L9B9B           := * + 1
        lda     $FDE3                           ; 9B9A AD E3 FD ...
        sta     $01,x                           ; 9B9D 95 01    ..
        lda     #$00                            ; 9B9F A9 00    ..
        rts                                     ; 9BA1 60       `
...
L9C96:  .byte   $80,$40,$20,$10,$08             ; 9C96 80 40 20 10 08.@ ..
; ----------------------------------------------------------------------------
L9C9B:  pha                                     ; 9C9B 48       H
...
; ----------------------------------------------------------------------------
LADBC:  jsr     get_current_physical_drive      ; ADBC 20 D9 AA  ..
